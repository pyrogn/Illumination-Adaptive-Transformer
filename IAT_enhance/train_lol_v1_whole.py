...
parser.add_argument(
    "--img_path",
    type=str,
    default="/data/unagi0/cui_data/light_dataset/LOL_v1/our485/low/",
)
parser.add_argument(
    "--img_val_path",
    type=str,
    default="/data/unagi0/cui_data/light_dataset/LOL_v1/eval15/low/",
)
...
parser.add_argument(
    "--pretrain_dir",
    type=str,
    default="workdirs/snapshots_folder_lol_v1_patch/best_Epoch.pth",
)

parser.add_argument("--num_epochs", type=int, default=400)
parser.add_argument("--display_iter", type=int, default=10)
parser.add_argument(
    "--snapshots_folder", type=str, default="workdirs/snapshots_folder_lol_v1_whole"
)
