...
parser.add_argument(
    "--img_path", type=str, default="/data/unagi0/cui_data/light_dataset/LOL/Train/Low/"
)
parser.add_argument(
    "--img_val_path",
    type=str,
    default="/data/unagi0/cui_data/light_dataset/LOL/Test/Low/",
)
parser.add_argument(
    "--normalize", action="store_false", help="Default Normalize in LOL training."
)
...
parser.add_argument(
    "--snapshots_folder", type=str, default="workdirs/snapshots_folder_lol"
)
...
for epoch in range(config.num_epochs):
    ...
    for iteration, imgs in enumerate(train_loader):
        ...
        loss = L1_smooth_loss(enhance_img, high_img) + 0.04 * loss_network(
            enhance_img, high_img
        )
